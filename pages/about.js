...
export default About = () => (<main className="container"> "Our goal as a professional breeder is simple, to deliver American Dobermans with the highest standard of quality to new 
...
be a single solution resource to inform, guide, and teach new members of our family!"</main>
)
